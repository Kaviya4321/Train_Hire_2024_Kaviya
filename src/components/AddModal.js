...
const AddModal = ({ form, handleChange, handleSubmit, setShowAddModal }) => {
    return (
        <div className="modal">
            <div className="modal-content">
                <span className="close" onClick={() => setShowAddModal(false)}>&times;</span>
                 ...
                 <form onSubmit={handleSubmit}>
                     ...
                     <input type="text" name="product_code" value={form.product_code} onChange={handleChange} required />                     <label>Product Name:</label>
